            ...
            <div id="sidebar" class="nav-collapse collapse">
                ...
                <ul>
                    ...
                    <li class="has-sub <? if (  (strpos($_SERVER['REQUEST_URI'], 'offer_list.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offer_add.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offer_edit.php') == true) || 
                                                (strpos($_SERVER['REQUEST_URI'], 'offergroup_list.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offergroup_add.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offergroup_edit.php') == true) ) echo 'active'; ?>">
                        <a href="javascript:;" class="">
