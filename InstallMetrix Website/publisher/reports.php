...
<div id="body">
 ...
 <script>
	 ...
	 function  getGeoCSV(startdate, enddate, campaign, subid, country, timezone) 
	 {
		reportspecs = "report_data.php?startDate="		+ startdate;
		reportspecs = reportspecs + "&endDate="			+ enddate;
		reportspecs = reportspecs + "&camp_6="	+ campaign;
     ...
     function  getDailyBreakdownCSV(startdate, enddate, searchCampaighn , searchSubid, searchCountry, timezone) 
     {
        reportspecs = "report_data.php?startDate="        + startdate;
        reportspecs = reportspecs + "&endDate="            + enddate;
	 ...
	 function  getDayCSV(startdate, enddate, searchCampaighn , searchSubid, searchCountry, timezone) 
	 {
		reportspecs = "report_data.php?startDate="		+ startdate;
		reportspecs = reportspecs + "&endDate="			+ enddate;
		reportspecs = reportspecs + "&searchCampaighn="	+ searchCampaighn;
        ...
        seriesColors: [ "#f89406"]
                                    ...
                                    <div class="tab-pane <? if ($_REQUEST[tab] == '5') { ?>active<? } ?>" id="portlet_tab5">
                                        ...
                                        <? if (($_REQUEST[tab] == '5') && ($_REQUEST[mode] == 'generate')) { ?>
                                            <div class="clearfix"></div>
                                            <br><br>
                                            <div class="widget-body form" style="overflow-y: scroll;">
                                    ...
                                    <div class="tab-pane <? if ($_REQUEST[tab] == '6') { ?>active<? } ?>" id="portlet_tab6">
                                        <div class="widget-body form span6" >
                                            ...
                                            <form action="#" class="form-horizontal" id="form_6" method="POST">
												...
												<div class="control-group">
                                                    <label class="control-label" for="input3">Campaign:</label>
                                                    <div class="controls">
                                                        <input type="text" id="camp_6" name="camp_6" value="<?= $_REQUEST[camp_6] ?>" class="span12"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="subid_6" name="subid_6" value="<?= $_REQUEST[subid_6] ?>" class="span12"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="country_6" name="country_6" value="<?= $_REQUEST[country_6] ?>" class="span12"/>
                                                    </div>
                                                </div>
