...
(function($) {
    ...
    $.jqplot.support_canvas = function() {
		if (typeof(this._support_canvas) == 'undefined') {
			this._support_canvas = !!document.createElement('canvas').getContext;
		}
		return this._support_canvas;
    };
            
    $.jqplot.support_canvas_text = function() {
		if (typeof(this._support_canvas_text) == 'undefined') {
			this._support_canvas_text = !!(document.createElement('canvas').getContext && typeof document.createElement('canvas').getContext('2d').fillText == 'function');
		}
		return this._support_canvas_text;
    };
	...
	$.jqplot.GenericCanvas.CANVASES.push(elem); // ANK
                ...
                switch (s.renderer.constructor) {
                    case $.jqplot.BarRenderer:
                        ...
                        for (j=s.gridData.length-1; j>=0; j--) {
							...
							// http://code.google.com/p/jqplot/updates/list
   ...
   $.jqplot.ColorGenerator = function(colors) {
    ...
    $.jqplot.TableLegendRenderer.prototype.addrow = function (label, color, pad, reverse) {
        ...
        $('<div class="jqplot-table-legend-type-key"><span class="jqplot-table-legend-type-color" style="background-color:'+color+'"></span><span class="jqplot-table-legend-type-label">'+label+'</span></div>').appendTo(this._elem);
    };
    ...
    $.jqplot.TableLegendRenderer.prototype.draw = function() {
        ...
        if (this.show) {
            ...
            this._elem = $('<div class="jqplot-table-legend-wrapper" style="'+ss+'"></div>');
