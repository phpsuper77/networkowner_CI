var App = function () {
    ...
    var handleDateTimePickers = function () {
        ...
        function (start, end) {                                                     			
            ...
            $('#form-date-range1-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));                                                     
            $('#form-date-range1-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));            
        ...
        function (start, end) {
            ...
            $('#form-date-range2-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));
            $('#form-date-range2-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));            
        });
        ...
        function (start, end) {
            ...
            $('#form-date-range3-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));
            $('#form-date-range3-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));
        });
        ...
        function (start, end) {
            ...
            $('#form-date-range4-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));
            $('#form-date-range4-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));
        });
        ...
        function (start, end) {
            ...
            $('#form-date-range5-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));
            $('#form-date-range5-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));
        });
        ...
        function (start, end) {
            ...
            $('#form-date-range6-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));
            $('#form-date-range6-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));
        });
        ...
        function (start, end) {
            ...
            $('#form-date-range7-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));
            $('#form-date-range7-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));
        });
        ...
        function (start, end) {
            ...
            $('#form-date-range8-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));
            $('#form-date-range8-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));
        });
        ...
        //form-date-range9
        {    
        $('#form-date-range9').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            var s = start.toString('MMMM d, yyyy');
            $('#form-date-range9 span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
            $('#form-date-range9-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));
            $('#form-date-range9-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));
        });
        ...
        //form-date-range10
        {    
        $('#form-date-range10').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            var s = start.toString('MMMM d, yyyy');
            $('#form-date-range10 span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
            $('#form-date-range10-startdate').val(start.toString('yyyy-MM-dd HH:mm:ss'));
            $('#form-date-range10-enddate').val(end.toString('yyyy-MM-dd HH:mm:ss'));
        });
...
function GetOffersByCategory_Bundle(bundle_id,cat_id)
{
    //alert(bundle_id);
    if ((bundle_id=="") || (cat_id==""))
    {
    ...
    xmlhttp.open("GET","ajax.php?mode=getoffersstable_by_bundle_category&bundle_id="+bundle_id+"&cat_id="+cat_id,true);
    xmlhttp.send();
}
 /*
function SaveTestSessionToCombo(combo_id,test_session)
{
    //alert(test_session);
