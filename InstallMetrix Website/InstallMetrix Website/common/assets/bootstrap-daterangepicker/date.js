...
function()
{
    ...
    $P.addMonths=function(value){
        var n=this.getDate();this.setDate(1);
    ...
    $P.my_add=function(config){  //this function is same with add(), because that default add is conflict with add of jQPlot //by David Lin
        if(typeof config=="number"){this._orient=config;return this;}
        var x=config;
        if(x.milliseconds){this.addMilliseconds(x.milliseconds);}
        if(x.seconds){this.addSeconds(x.seconds);}
