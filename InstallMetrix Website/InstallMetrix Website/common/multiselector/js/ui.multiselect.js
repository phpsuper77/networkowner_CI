...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.selectedActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><input type="text" class="search-right empty ui-widget-content ui-corner-all"/><a href="#" class="remove-all">'+$.ui.multiselect.locale.removeAll+'</a></div>').appendTo(this.selectedContainer);
		...
		if (this.options.searchable) {
            ...
            this._registerSearchEvents(this.selectedContainer.find('input.search-right'), true);
		} else {
			$('.search').hide();
		}
	...
	_setSelected: function(item, selected) {
        //alert(item.data('optionLink').val());
	...
	_filter: function(list) {
		...
		if (!term) {
			...
			$.each(scores, function() {
                //alert(xx);
                xx++;
                //alert($(rows[this]).data('optionLink').val());
				$(rows[this]).show();
			});
		}
	},
	...
	_registerSearchEvents: function(input, isRightSearch) {
		var that = this;
