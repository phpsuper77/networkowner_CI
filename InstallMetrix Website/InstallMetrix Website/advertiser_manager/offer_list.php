...
<div id="body">
    ...
    <div class="container-fluid">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane <? if (($_REQUEST[tab] == '1') || ($_REQUEST[tab] == '')) { ?>active<? } ?>" id="portlet_tab1">
                                        ...
                                        <tbody>
                                            <?                                    
                                            $sql = "
        SELECT o.id, o.user_id, o.assigned_user_id, o.offer_datetime, o.offer_name, o.offer_price, o.offer_show,                
        ...
        WHERE o.offer_show=1 AND o.status=0 AND u2.user_manager={$user_id}
        ORDER BY o.id DESC
                                            ";
        ...
        FROM offers o      
             LEFT JOIN users u2 ON o.assigned_user_id=u2.id
        WHERE o.offer_show=0 AND o.status=0 AND u2.user_manager={$user_id}
        ORDER BY o.id DESC
                                            ";
