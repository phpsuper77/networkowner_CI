...
if ($_REQUEST[tryout] == '1') {
    ...
    if ($errmsg != '') {
        ...
        //save domains
        $sql = "DELETE FROM domain_publisher WHERE pub_id={$_REQUEST[id]}";
        mysql_query($sql);
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            ...
                            <form action="pub_edit.php" class="form-horizontal" method="POST" id="add_form" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="input3"> Assigned Domains</label>
                                    <div class="controls">
                                        <select id="domains" class="multiselect" multiple="multiple" name="domains[]" style="display: none; width:500px;height: 250px;">
                                          <?php                                                                                                        
                                                $sql = "SELECT id, domain FROM domains WHERE status=0 AND id NOT IN (SELECT domain_id FROM domain_publisher WHERE pub_id={$_REQUEST[id]})";
                                                //var_dump($sql);exit;
                                                $q = mysql_query($sql);
                                          ...
                                          <?php
                                                ...
                                                $sql = "SELECT id, domain FROM domains WHERE status=0 AND id IN (SELECT domain_id FROM domain_publisher WHERE pub_id={$_REQUEST[id]})";
                                                //var_dump($sql);exit;
                                                $q = mysql_query($sql);
                                                while ($row = mysql_fetch_assoc($q)) {
                                          ?>
