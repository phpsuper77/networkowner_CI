...
<div id="body">
 ...
 <script>
	...
	function  getRCSV(startdate, enddate, searchString, timezone) 
	{
	 ...
	 function  getGeoCSV(startdate, enddate, pub, camp, subid, country, timezone) 
	 {
		reportspecs = "report_data.php?startDate="		+ startdate;
		reportspecs = reportspecs + "&endDate="			+ enddate;
     ...
     function  getDailyBreakdownCSV(startdate, enddate, searchPub, searchCampaighn , searchSubid, searchCountry, timezone) 
     {
        reportspecs = "report_data.php?startDate="        + startdate;
        reportspecs = reportspecs + "&endDate="            + enddate;
	 ...
	 function  getDayCSV(startdate, enddate, searchPub, searchCampaighn , searchSubid, searchCountry, timezone) 
	 {
		reportspecs = "report_data.php?startDate="		+ startdate;
		reportspecs = reportspecs + "&endDate="			+ enddate;
		reportspecs = reportspecs + "&searchPub="		+ searchPub;
                                ...
                                //echo("<textarea>" . $sql . "</textarea>"); exit;
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($q)) { 
                                                            ...
                                                            if ($rowcount < 5)
                                                            {
                                                                ...
                                                                array_push($topAmount,$row[pub_revenue]);                                                                
                                                            }
                                                            $rowcount ++;
                                                        }
                                                        ?>
